...
func main() {
	...
	flag.BoolVar(&secureMetrics, "metrics-secure", false,
		"If set, the metrics endpoint is served securely via HTTPS. Default is plain HTTP for Prometheus scraping.")
	...
	if err := (&controller.WorkloadDependencyReconciler{
		Client:   mgr.GetClient(),
		Scheme:   mgr.GetScheme(),
		Recorder: mgr.GetEventRecorderFor("klink"),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "Failed to create controller", "controller", "workloaddependency")
		os.Exit(1)
	}
